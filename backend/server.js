...
// Behind Cloudflare/ngrok quick tunnels we need to trust the forwarded headers
...
const authLimiter = rateLimit({
  ...
  validate: {
    // Cloudflare/ngrok already sit in front — skip strict X-Forwarded-For validation
...
app.get('/api/health', async (req, res) => {
  try {
    // Fetch a single row to verify Supabase connectivity (aggregates blocked by RLS)
