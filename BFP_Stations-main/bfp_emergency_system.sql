...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2025 at 05:27 PM
...
INSERT INTO `firetrucks` (`truck_id`, `plate_number`, `model`, `station_id`, `driver_user_id`, `current_latitude`, `current_longitude`, `last_location_update`) VALUES
(1, 'FT-ZAMB-001', 'Hino 500', 101, NULL, NULL, NULL, '2025-11-28 13:10:23'),
(2, 'FT-ZAMB-002', 'Isuzu FVR', 102, NULL, NULL, NULL, '2025-11-28 13:10:23'),
(3, 'FT-ZAMB-003', 'Fuso Fighter', 103, NULL, NULL, NULL, '2025-11-28 13:10:23');
...
(103, 'Sta Catalina FSS FT', 'Zamboanga', 'Zamboanga City', '991226769588', 7.51500000, 122.01500000, 0, '2025-11-30 16:24:31', 'Substation'),
...
--
ALTER TABLE `alarms`
  MODIFY `alarm_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `station_readiness`
  MODIFY `readiness_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
