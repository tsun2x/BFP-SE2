...
export default function Settings() {
  ...
  useEffect(() => {
    if (user) {
      setProfile((prev) => ({
        ...
        middleName:
          user.middle_name || user.middleName || prev.middleName || "",
    ...
    try {
      ...
      if (cached) {
        setProfile((prev) => ({
          ...
          middleName:
            cached.middle_name || cached.middleName || prev.middleName || "",
    ...
    const hydrateMe = async () => {
      try {
        ...
        setProfile((prev) => ({
          ...
          station:
            me.station_name || me.substation || me.station || prev.station,
        ...
        try {
          ...
          if (uid) {
            ...
            const resolvedAvatar =
              localAvatar || me.profile_picture_url || null;
        ...
        if (me.securitySettings) {
          setSecurity((prev) => ({ ...prev, ...me.securitySettings }));
        } else {
          try {
            const saved = localStorage.getItem("securitySettings");
            if (saved)
              setSecurity((prev) => ({ ...prev, ...JSON.parse(saved) }));
          } catch (e) {}
        }
      } catch (err) {
        ...
        try {
          const saved = localStorage.getItem("securitySettings");
          if (saved) setSecurity((prev) => ({ ...prev, ...JSON.parse(saved) }));
        } catch (e) {}
      }
    };
  ...
  const handleSaveNotifications = async () => {
    ...
    try {
      await apiClient.put("/me", { notificationPreferences: notifications });
  ...
  const handleSearchCoordinates = async () => {
    ...
    try {
      const res = await apiClient.get(
        `/geocode?q=${encodeURIComponent(q)}&limit=1`,
      );
  ...
  const handleSaveStationSettings = async () => {
    ...
    if (
      ...
      stationSettings.stationName.trim() === ""
    ) {
    ...
    const lat =
      stationSettings.latitude !== ""
        ? parseFloat(stationSettings.latitude)
        : null;
    const lng =
      stationSettings.longitude !== ""
        ? parseFloat(stationSettings.longitude)
        : null;
      ...
      if (user?.role === "admin") {
        if (editingStationId) {
          await apiClient.put(`/firestations/${editingStationId}`, {
            ...
            address: stationSettings.address?.trim()
              ? stationSettings.address.trim()
              : null,
            latitude: lat,
            longitude: lng,
          });
  ...
  const fetchStations = async () => {
    ...
    try {
      ...
      const stationList = Array.isArray(data)
        ? data
        : data.stations || data.firestations || data.data || [];
  ...
  const handleConfirmSaveProfile = async () => {
    ...
    try {
      await apiClient.post("/verify-password", {
        password: confirmProfilePassword,
      });
    } catch (err) {
  ...
  const handleSaveSecuritySettings = async () => {
    ...
    try {
      await apiClient.put("/me", { securitySettings: security });
      try {
      ...
      toast.error("Could not save to server. Settings saved locally.");
    } finally {
          ...
          <div className="settings-content">
                ...
                <div className="settings-form">
                  ...
                  <div className="form-group">
                    ...
                    <select
                      value={profile.rank}
                      onChange={(e) =>
                        handleProfileChange("rank", e.target.value)
                      }
                    >
            ...
            {activeTab === "notifications" && (
              <div className="settings-section">
                ...
                <p className="section-description">
                  Manage your emergency alert preferences
                </p>
            ...
            {activeTab === "accounts" && (
              <div className="settings-section">
                ...
                <p className="section-description">
                  View all registered officer accounts across all stations
                </p>
                    ...
                    >
                      ...
                      <tbody>
                        {officers.map((o, i) => {
                          const stationName =
                            stations.find(
                              (s) => s.station_id === o.assigned_station_id,
                            )?.station_name ||
                            (o.assigned_station_id
                              ? `Station #${o.assigned_station_id}`
                              : "—");
                          return (
                            <tr
                              key={o.id}
                            ...
                            >
                              ...
                              <td
                                style={{ padding: "10px 14px", color: "#555" }}
                              >
                                {o.rank || "—"}
                              </td>
            ...
            {activeTab === "station" && (
              <div className="settings-section">
                ...
                <p className="section-description">
                  Create, edit, and manage fire stations
                </p>
                    ...
                    >
                      ...
                      <div>
                        <button
                          ...
                          style={{
                            background:
                              "linear-gradient(135deg, #b22222, #dd2c2c)",
                            border: "none",
                            color: "#fff",
                          }}
                        >
                            ...
                            >
                              <div>
                                ...
                                <div style={{ color: "#555", marginTop: 6 }}>
                                  ...
                                  {s.contact_number || s.contactNumber || "-"}
                                </div>
                                <div
                                  style={{
                                    color: "#666",
                                ...
                                >
                                  <span style={{ marginRight: 12 }}>
                                    <strong>Lat:</strong> {s.latitude}
                                  </span>
                                  <span>
                                    <strong>Lng:</strong> {s.longitude}
                                  </span>
                                </div>
                              </div>
                              <div style={{ display: "flex", gap: 8 }}>
                                <button
                                  ...
                                  onClick={() =>
                                    handleDeleteClick(s.station_id)
                                  }
                                ...
                                <button
                                  className="btn btn-outline"
                                  onClick={() => handleEditClick(s.station_id)}
                          ...
                          <div style={{ marginTop: 8 }}>
                            ...
                            <div className="form-group">
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  handleStationChange("address", e.target.value)
                                }
                            ...
                            {geoAccuracyMeters !== null && (
                              ...
                              >
                                Accuracy: ~
                                {Math.round(Number(geoAccuracyMeters))} m
                              </div>
                            )}
                            <div className="form-row">
                              <div className="form-group">
                            ...
                            <div className="form-group">
                              ...
                              <select
                                value={
                                  stationSettings.stationType || "Substation"
                                }
                                onChange={(e) =>
                                  handleStationChange(
                                    "stationType",
                        ...
                        <div className="modal-card">
                          ...
                          <div className="form-group">
                            ...
                            <input
                              ...
                              onKeyPress={(e) =>
                                e.key === "Enter" && handleConfirmDelete()
                              }
          ...
          >
            ...
            <div style={{ marginBottom: 18 }}>
              ...
              <input
                ...
                onKeyDown={(e) =>
                  e.key === "Enter" && handleConfirmSaveProfile()
                }
                placeholder="Enter your password"
                style={{
                  width: "100%",
            ...
            >
              ...
              >
                {isConfirmingProfile || isSavingProfile
                  ? "Saving..."
                  : "Confirm & Save"}
              </button>
            </div>
