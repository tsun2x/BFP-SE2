...
const LoginScreen: React.FC<Props> = ({ onGoToRegister }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Sign in with your BFP badge ID and password to start tracking.</Text>
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#ffffff', paddingHorizontal: 24, paddingTop: 80 },
  title: { fontSize: 24, fontWeight: 'bold', color: '#B71C1C', marginBottom: 8, textAlign: 'center' },
