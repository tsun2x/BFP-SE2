...
export default function Dashboard() {
  ...
  const dispatchedOnly = periodIncidents.filter(
    (i) => i.status === "Dispatched",
  ).length;
  const onScene = periodIncidents.filter((i) => i.status === "On Scene").length;
  const underControl = periodIncidents.filter(
    (i) => i.status === "Under Control",
  ).length;
  const resolved = periodIncidents.filter(
    (i) => i.status === "Resolved",
  ).length;
  const cancelled = periodIncidents.filter(
  ...
  const statusClass = (status) => {
    ...
    if (status === "Dispatched" || status === "On Scene")
                ...
                <div className="class-details">
                  ...
                  <div className="class-stats">
                    ...
                    <span className="class-percent">
                      {totalCalls
                        ? Math.round((pending / totalCalls) * 100)
                        : 0}
                      %
                    </span>
                  </div>
              ...
              <div className="class-item">
                ...
                <div className="class-details">
                  ...
                  <div className="class-stats">
                    ...
                    <span className="class-percent">
                      {totalCalls
                        ? Math.round((dispatchedOnly / totalCalls) * 100)
                        : 0}
                      %
                    </span>
                  </div>
              ...
              <div className="class-item">
                ...
                <div className="class-details">
                  ...
                  <div className="class-stats">
                    ...
                    <span className="class-percent">
                      {totalCalls
                        ? Math.round((onScene / totalCalls) * 100)
                        : 0}
                      %
                    </span>
                  </div>
              ...
              <div className="class-item">
                ...
                <div className="class-details">
                  ...
                  <div className="class-stats">
                    ...
                    <span className="class-percent">
                      {totalCalls
                        ? Math.round((underControl / totalCalls) * 100)
                        : 0}
                      %
                    </span>
                  </div>
              ...
              <div className="class-item">
                ...
                <div className="class-details">
                  ...
                  <div className="class-stats">
                    ...
                    <span className="class-percent">
                      {totalCalls
                        ? Math.round((cancelled / totalCalls) * 100)
                        : 0}
                      %
                    </span>
                  </div>
