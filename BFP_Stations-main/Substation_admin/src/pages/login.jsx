...
export default function Login() {
  ...
  const validateForm = () => {
    ...
    if (!formData.idNumber.trim()) {
      ...
      newErrors.idNumber = 'Invalid ID format (e.g., BFP-00201)';
    }
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        // Validate: user must be substation_admin and must have an assigned station
        ...
        if (!user?.assignedStationId) {
          localStorage.removeItem('authToken');
          localStorage.removeItem('user');
          setLoginError('Your account is not assigned to any station. Contact your administrator.');
          setFormData((prev) => ({ ...prev, password: '' }));
          return;
        }
        // Station is determined automatically from credentials
        navigate('/');
      } else {
        ...
        <div className="login-left">
          <div className="login-left-content">
            ...
            <div className="login-features">
              ...
              <ul>
                <li>Enter your BFP ID number (e.g., BFP-00201)</li>
                <li>Your station is automatically determined from your credentials</li>
