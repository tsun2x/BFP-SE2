...
export const API_URL = 'https://national-buddy-learning-junior.trycloudflare.com';
export const NODE_API_URL = 'https://national-buddy-learning-junior.trycloudflare.com';
